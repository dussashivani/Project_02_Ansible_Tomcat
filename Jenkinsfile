    ...
    stages {
        ...
        stage('CLONE GITHUB CODE') {
            steps {
                ...
                git branch: 'main', url: 'https://github.com/dussashivani/Project_02_Ansible_Tomcat.git'
            }
        }
        ...
        stage('DEPLOY WITH ANSIBLE') {
            steps {
                ...
                sh '''
                    ...
                    ansible-playbook -i ansible/inventory ansible/deploy_tomcat.yml --extra-vars "artifact=$ARTIFACT"
                '''
            }
        }
    }
